...
urlpatterns = [
    ...
    path(
        ...
        name="astronomy-show-detail",
    ),
    path(
        "planetarium_domes/",
        PlanetariumDomeList.as_view(),
        name="planetarium-dome-list",
    ),
    path(
        "planetarium_domes/<int:pk>/",
        PlanetariumDomeDetail.as_view(),
        name="planetarium-dome-detail",
    ),
